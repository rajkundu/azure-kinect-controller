// Forked and slightly modified from https://github.com/nbsdx/SimpleJSON
#pragma once
...
class JSON
{
    ...
    public:
        ...
        string ToStringNoEscape() const { bool b; return std::move( ToString( b, false ) ); }
        string ToString( bool &ok, bool escape = true ) const {
            ok = (Type == Class::String);
            return ok ? std::move( escape ? json_escape( *Internal.String ) : *Internal.String ): string("");
        }
